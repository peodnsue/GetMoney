...
const BackButton = ({ text = '返回', to }: BackButtonProps) => {
  ...
  return (
    <StyledWrapper>
      <div className="btn-container">
        <div className="btn-drawer transition-top">返回上一页</div>
        <div className="btn-drawer transition-bottom">点击返回</div>
...
const StyledWrapper = styled.div`
  ...
  .btn-text {
    ...
    background-image: linear-gradient(#78350f, #451a03);
  ...
  .btn-container:has(.btn:focus-visible) {
    ...
    .btn-corner:first-of-type {
      transform: translate(
        ...
        rotate(90deg);
      filter: drop-shadow(-8px 8px 1px var(--corner-color))
        drop-shadow(-16px 16px 2px var(--corner-color));
      -webkit-filter: drop-shadow(-8px 8px 1px var(--corner-color))
        drop-shadow(-16px 16px 2px var(--corner-color));
    }
    .btn-corner:nth-of-type(2) {
      transform: translate(
  ...
  .btn-container:has(.btn:active) {
    .btn {
      ...
      filter: drop-shadow(0 8px 4px #0002);
      -webkit-filter: drop-shadow(0 8px 4px #0002);
    }
    .transition-top,
    .transition-bottom {
    ...
    .btn-corner:first-of-type {
      transform: translate(
        ...
        rotate(90deg);
      filter: drop-shadow(-8px 8px 2px var(--corner-color))
        drop-shadow(-16px 16px 3px var(--corner-color));
      -webkit-filter: drop-shadow(-8px 8px 2px var(--corner-color))
        drop-shadow(-16px 16px 3px var(--corner-color));
    }
    .btn-corner:nth-of-type(2) {
      transform: translate(
